...
-
    ...
    if (terminalInput && terminalBody) {
        ...
        const showHelp = () => {
            addLine('<span class="terminal-info">Comandos disponíveis:</span>');
            addLine('<span class="terminal-cmd-example"><span class="cmd-text">inicio</span> - Ir para a página inicial</span>');
            ...
            addLine('<span class="terminal-cmd-example"><span class="cmd-text">help</span> - Exibir esta lista de ajuda</span>');
            addLine('<br>');
        };
        ...
        const executeCommand = (cmd) => {
            ...
            addLine(`<span class="terminal-command-line"><span class="terminal-prompt">visitor@ibrunodev:~$</span> <span class="cmd-text">${cmd}</span></span>`);
            ...
            if (cmd === '') {
                ...
                addLine(`<span class="terminal-success">Redirecionando para ${cmd}...</span>`);
                addLine('<br>');
